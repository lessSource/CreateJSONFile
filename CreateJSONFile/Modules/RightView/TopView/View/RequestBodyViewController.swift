...
class RequestBodyViewController: NSViewController {
    ...
    // MARK: - public
    public func getRequestBody() -> Dictionary<String, String> {
...
extension RequestBodyViewController: NSTableViewDelegate, NSTableViewDataSource {
